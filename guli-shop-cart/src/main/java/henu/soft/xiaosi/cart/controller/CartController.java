package henu.soft.xiaosi.cart.controller;
...
public class CartController {
    ...
    public String checkCart(@RequestParam("isChecked") Boolean isChecked, @RequestParam("skuId") Long skuId) {
        cartService.checkCart(skuId, isChecked);
        return "redirect:http://cart.gulishop.cn/cart.html";
    }
