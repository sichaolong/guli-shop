...
import henu.soft.xiaosi.member.service.MemberReceiveAddressService;
...
public class MemberReceiveAddressController {
    ...
    @RequestMapping("/addressinfo/{id}")
    R addressInfo(@PathVariable("id") Long id){
        MemberReceiveAddressEntity memberReceiveAddressEntity = memberReceiveAddressService.getById(id);
        MemberAddressTo memberAddressTo = new MemberAddressTo();
        BeanUtils.copyProperties(memberReceiveAddressEntity,memberAddressTo);
        return R.ok().setData(memberAddressTo);
