...
import henu.soft.xiaosi.product.feign.CouponFeignService;
import henu.soft.xiaosi.product.feign.SearchFeignService;
import henu.soft.xiaosi.product.feign.WareFeignService;
import henu.soft.xiaosi.product.service.*;
import henu.soft.xiaosi.product.vo.*;
...
import henu.soft.xiaosi.product.dao.SpuInfoDao;
...
public class SpuInfoServiceImpl extends ServiceImpl<SpuInfoDao, SpuInfoEntity> implements SpuInfoService {
    ...
    public void up(Long spuId) {
        ...
        try {
            ...
            stockMap = data.stream().collect(Collectors.toMap(SkuHasStockTo::getSkuId, SkuHasStockTo::getHasStock));
        } catch (Exception e) {
