...
MySQL - 5.7.35 : Database - guli-shop_ums
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`guli-shop_ums` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
CREATE TABLE `ums_member` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='会员';

/*Data for the table `ums_member` */

insert  into `ums_member`(`id`,`level_id`,`username`,`password`,`nickname`,`mobile`,`email`,`header`,`gender`,`birth`,`city`,`job`,`sign`,`source_type`,`integration`,`growth`,`status`,`create_time`,`social_uid`,`access_token`,`expires_in`) values (1,1,'firenay','$2a$10$uDXc05.IsjGI//f7HC8/lOGys0oRiFZX59olzqVqTl8IKxR8iBVGy','firenay','18173516208','xxx@gmail.com',NULL,0,'2020-06-25','湖南 长沙','JAVA',NULL,NULL,NULL,NULL,0,'2020-06-25 13:09:14',NULL,NULL,NULL),(2,1,'sentinel','$2a$10$j5XRpUeGq7AYIFk7pqdvyebK.Bo5MvasCxk.8RuBWsHFcq5RzXKEC','sentinel','18173516102','xxx@gmail.com',NULL,1,'2020-06-25','湖南 长沙','JAVA',NULL,NULL,NULL,NULL,0,'2020-06-25 13:15:33',NULL,NULL,NULL),(3,1,'firenayfly','$2a$10$UvvfpBagTqbalI6UTnq5nOiPheEdbKLO64fozWMx1lUeK9p2tM366','firenayfly','18467894965','xxx@gmail.com',NULL,1,'2020-06-25','湖南 长沙','JAVA',NULL,NULL,NULL,NULL,0,'2020-06-25 13:18:32',NULL,NULL,NULL),(4,1,'汀西氟的我是你','$2a$10$uDXc05.IsjGI//f7HC8/lOGys0oRiFZX59olzqVqTl8IKxR8iBVGy','汀西氟的我是你','18467894965','xxx@gmail.com',NULL,1,'2020-06-26','湖南 长沙','自媒体',NULL,NULL,NULL,NULL,0,'2020-06-26 09:36:00','5605937365','2.00b5w4HGMwxc6B0e3d62c666DlN1DD','157679999'),(5,1,NULL,NULL,'xiaosi720',NULL,NULL,'https://gitee.com/assets/no_portrait.png',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'8638250','8a4a22ee06569fee383065e0065aeb49','86400');
...
CREATE TABLE `ums_member_receive_address` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='会员收货地址';

/*Data for the table `ums_member_receive_address` */

insert  into `ums_member_receive_address`(`id`,`member_id`,`name`,`phone`,`post_code`,`province`,`city`,`region`,`detail_address`,`areacode`,`default_status`) values (1,1,'firenay','18173516208',NULL,'湖南','长沙',NULL,'望城区',NULL,1),(2,2,'sentinel','18173516102',NULL,'湖南','长沙',NULL,'雨花区',NULL,1),(3,3,'firenayfly','15421564125',NULL,'陕西','西安',NULL,'新城区',NULL,1),(4,5,'xiaosi','11066666666',NULL,'河南','开封',NULL,'龙亭区',NULL,1),(5,NULL,'si','11188888888',NULL,'浙江','杭州',NULL,'阿里巴巴集团',NULL,1);
